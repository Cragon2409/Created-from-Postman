...
"""
#Stats - [Max Health, Health Regeneration, Player Speed, Body Domage,    Bullet Damage, Bullet Endurance, Bullet Speed, Reload ||    Tank Radius, Tank Shape Type]
TANK_STATS = { #max at 5
    "Basic"         : [0,0,0,0,     0,0,0,0,        10,0],

    "Flank"         : [1,0,0,0,     0,0,0,1,        10,0],
    "Sniper"        : [1,0,-1,0,    1,1,1,-1,       10,0],
    "Machine Gun"   : [1,0,0,0,     -1,0,0,1,       10,0],
    "Twin"          : [1,0,0,0,     0,0,0,1,        10,0],

    "Hybrid"        : [2,1,1,0,     1,0,0,2,        12,0],
    "Quad"          : [2,1,1,0,     0,0,1,2,        12,0],
    "Double Twin"   : [2,1,1,0,     1,0,0,2,        12,0],
    "Cannon"        : [2,1,1,1,     2,3,2,-3,       12,0],
    "Overseer"      : [2,1,1,0,     1,2,1,0,        12,0],
    "Hunter"        : [2,1,-1,0,    2,1,2,-1,       12,0],
    "Gunner"        : [2,1,1,0,     -1,-1,0,4,      10,0],
    "Triple Shot"   : [2,1,1,1,     1,0,0,2,        12,0],

    "Octo"          : [3,2,2,0,     0,0,2,3,        15,0],
    "Quad Twin"     : [3,2,2,0,     2,0,2,2,        15,0],
    "Battleship"    : [3,2,-3,0,    0,2,3,2,        15,0],
    "Auto Gunner"   : [3,2,2,0,     0,-1,2,2,       10,0],
    "Fighter"       : [0,2,2,0,     5,5,5,5,        15,0],
    "Penta Shot"    : [3,2,2,0,     2,0,0,3,        15,0],
    "Mortar"        : [3,2,2,0,     5,4,3,-5,       15,0],
    "Stalker"       : [3,2,0,0,     5,3,5,-1,       15,0],
    "Boxer"         : [5,3,4,5,     0,0,0,0,        20,0]
}
...
TANK_TURRET_SPECS = {
    ...
    "Fighter"       : [ [BULLET_TYPE_CODE,5,17,0,0 ] ], #FIXME idk what to do with this one
