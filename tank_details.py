...
TANK_STATS = { #max at 5
    ...
    "Flank"         : [1,0,0,0,     0,0,0,1,        10,0,3],
    "Sniper"        : [1,0,-1,0,    1,1,1,-1,       10,0,2.25],
    "Machine Gun"   : [1,0,0,0,     -1,0,0,1,       10,0,3],
    "Twin"          : [1,0,0,0,     0,0,0,1,        10,0,3],

    "Hybrid"        : [2,1,1,0,     1,0,0,2,        12,0,3],
    "Quad"          : [2,1,1,0,     0,0,1,2,        12,0,3],
    "Double Twin"   : [2,1,1,0,     1,0,0,2,        12,0,3],
    "Cannon"        : [2,1,1,1,     2,3,2,-3,       12,0,3],
    "Overseer"      : [2,1,1,0,     1,2,1,0,        12,0,3],
    "Hunter"        : [2,1,-1,0,    2,1,2,-1,       12,0,2],
    "Gunner"        : [2,1,1,0,     -1,-1,0,4,      10,0,3],
    "Triple Shot"   : [2,1,1,1,     1,0,0,2,        12,0,3],

    "Octo"          : [3,2,2,0,     0,0,2,3,        15,0,3],
    "Quad Twin"     : [3,2,2,0,     2,0,2,2,        15,0,3],
    "Battleship"    : [3,2,-3,0,    0,2,3,2,        15,0,3],
    "Auto Gunner"   : [3,2,2,0,     0,-1,2,2,       10,0,3],
    "Fighter"       : [0,2,2,0,     5,5,5,5,        15,0,3],
